...
def create_users_for_methods():
    with TestingSessionLocal() as db:
        ...
        user_repository.create_user("tamarapantic1@gmail.com", "sifra123")
        user_repository.create_user("tamarapantic2@gmail.com", "sifra123")
        user_repository.create_user("tamarapantic3@gmail.com", "sifra123")
        user_repository.create_user("tamarapantic4@gmail.com", "sifra123")
...
class TestUserRepo(TestClass):
    ...
    def test_create_user(self):
        with TestingSessionLocal() as db:
            user_repository = UserRepository(db)
            user = user_repository.create_user(email="tamtam@gmail.com", password="sifra123")
    ...
    def test_create_user_error(self):
        with TestingSessionLocal() as db:
            user_repository = UserRepository(db)
            user = user_repository.create_user("tamtam@gmail.com", "sifra123")
            assert user.active is not False
            with pytest.raises(IntegrityError):
                user_repository.create_user("tamtam@gmail.com", "sifra123")

    def test_create_superuser(self):
        with TestingSessionLocal() as db:
            user_repository = UserRepository(db)
            superuser = user_repository.create_superuser("daki@gmail.com", "sifra1253")
    ...
    def test_create_superuser_error(self):
        with TestingSessionLocal() as db:
            user_repository = UserRepository(db)
            superuser = user_repository.create_superuser("velja@gmail.com", "sifra1253")
            assert superuser.superuser is not False
            with pytest.raises(IntegrityError):
                user_repository.create_superuser("velja@gmail.com", "sifra1253")
