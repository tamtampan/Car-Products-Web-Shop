...
class ProductController:
    ...
    def read_all() -> list[object]:
        ...
        try:
            ...
            raise HTTPException(status_code=exc.code, detail="No products in system.")
        except Exception as exc:
            raise HTTPException(status_code=500, detail=str(exc))
    ...
    def delete_by_id(product_id: str) -> Response:
        ...
        try:
            ...
            return JSONResponse(status_code=200, content=f"Product with id - {product_id} deleted.")
        except ProductNotFoundError as exc:
            raise HTTPException(status_code=exc.code, detail=exc.message)
        except IntegrityError:
    ...
    def update_quantity_in_stock(product_id: str, amount: int, subtract: bool = False) -> object:
        ...
        try:
            ...
            return product
        except ProductQuantityInStockSubtractionError as exc:
            raise HTTPException(status_code=exc.code, detail=exc.message)
        except ProductNotFoundError as exc:
            raise HTTPException(status_code=exc.code, detail=exc.message)
        except Exception as exc:
    ...
    def read_products_for_car_brand(car_brand: str) -> list[object]:
        ...
        try:
            ...
            raise HTTPException(status_code=exc.code, detail=f"No products for {car_brand} in system.")
        except Exception as exc:
            raise HTTPException(status_code=500, detail=str(exc))
    ...
    def read_products_by_category_name(product_category_name: str) -> list[object]:
        ...
        try:
            ...
            raise HTTPException(status_code=exc.code, detail=f"No products for {product_category_name} in system.")
        except Exception as exc:
            raise HTTPException(status_code=500, detail=str(exc))
    ...
    def read_all_products_alphabetically_sorted() -> list[object]:
        ...
        try:
            ...
            raise HTTPException(status_code=exc.code, detail="No products for in system.")
        except Exception as exc:
            raise HTTPException(status_code=500, detail=str(exc))
    ...
    def read_products_name_like(name: str) -> list[object]:
        ...
        try:
            ...
            raise HTTPException(status_code=exc.code, detail=f"No products with name like {name} in system.")
        except Exception as exc:
            raise HTTPException(status_code=500, detail=str(exc))
    ...
    def read_by_code(code: str) -> object:
        ...
        try:
            ...
            return product
        except ProductCodeNotFoundError as exc:
            raise HTTPException(status_code=exc.code, detail=exc.message)
        except Exception as exc:
            raise HTTPException(status_code=500, detail=str(exc))
